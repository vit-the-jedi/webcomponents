import{P as p}from"./progress.js";class d extends p{constructor(){super(),this.classList.add("component-positioned");const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.classList.add("progress-wrapper");const n=document.createElement("div");n.classList.add("progress-bar"),n.max=this.getAttribute("data-max"),n.value=this.getAttribute("data-value"),n.id="progress-bar-component";const s=document.createElement("div");s.classList.add("progress-bar-inner"),s.style.width="0%",n.appendChild(s),t.appendChild(n),e.appendChild(t),this.shadow=e,document.dispatchEvent(new Event("componentCreated"))}static get observedAttributes(){return["percentcomplete"]}attributeChangedCallback(e,t,n){let o=[...this.shadowRoot.children].filter(a=>{if(a.classList.contains("progress-wrapper"))return a.querySelector(".progress-bar-inner")});o=o[0];const c=o.querySelector(".progress-bar-inner"),i=this._percentcomplete;e==="percentcomplete"&&(this._percentcomplete=i,setTimeout(()=>{c.style.width=i+"%"},250))}get percentcomplete(){return this._percentcomplete}set percentcomplete(e){this._percentcomplete<=this._maxValue&&this.setAttribute("percentcomplete",e)}createStyles(){const e=`
    ...
    .progress-bar-inner {
      ...
      border-radius: 10px;
    }`,t=document.createElement("style");return t.textContent=e,t}getAnchorPoint(e){return new Promise((t,n)=>{function s(){const o=document.querySelector(e);o&&(clearInterval(r),t(o))}const r=setInterval(s,50)})}getComponentAnchorPoint(){return new Promise(async(e,t)=>{this._anchorPoint=await this.getAnchorPoint(this.getConfigs("anchorPoint")),e()})}init(e,t){t(e),this.getAnchorPoint(this.getConfigs("anchorPoint")).then(n=>{n.parentElement.insertBefore(this,n.nextElementSibling)})}createProgressBarComponent(){document.createElement("div").classList.add("progress-container"),this.setAttribute("data-max","100"),this.setAttribute("data-steps",this.getConfigs("steps")),this.shadow.prepend(this.createGlobalStyles()),this.shadow.prepend(this.createStyles()),document.dispatchEvent(new Event("componentMounted"))}connectedCallback(){document.dispatchEvent(new Event("componentBeforeMount")),this.log("component connected");const e=JSON.parse(sessionStorage.getItem("custom-component__state"));e?(e.updated=!1,e._progressState.activeStep=e._progressState.activeStep+1,e._percentcomplete=e._percentcomplete+e._stepIncrement,this.initFromLastKnownState(e)):(this.registerEvents(),this.createProgressBarComponent())}disconnectedCallback(){this.log("component disconnected"),document.dispatchEvent(new Event("componentUnmounted"))}}customElements.define("progress-bar",d);export{d as P};
